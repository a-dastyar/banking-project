...
@Slf4j
@WebServlet("/bank-accounts/balance")
...
public class BankAccountBalanceServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.sendRedirect(req.getContextPath() + "/bank-accounts/details?account_number=" + account_number);
    }
