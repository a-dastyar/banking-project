...
@Slf4j
@WebServlet("/checking-accounts/balance")
...
public class CheckingAccountBalanceServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.sendRedirect(req.getContextPath() + "/checking-accounts/details?account_number=" + account_number);
    }
