...
<div class="container-sm w-75 mt-3 p-3 border rounded">
    <form method="POST" action="${pageContext.request.contextPath}/checking-accounts" class="needs-validation add-account-form" id="add-checking-account-form" novalidate>
        <%@ include file="/views/components/accounts/common_form_fields.jsp" %>
        <div class="mb-3 row offset-sm-2">
            <label class="col-form-label col-md-4" for="overdraft_limit">Overdraft limit</label>
        ...
        <div class="mb-3 row offset-sm-2">
            <label class="col-form-label  col-md-4" for="debt">Debt</label>
            <div class="col-sm-6 has-validation" >
