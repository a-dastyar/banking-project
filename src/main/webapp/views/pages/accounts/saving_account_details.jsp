...
<html lang="en">
    ...
    <head>
        ...
        <title>Saving account | ${accountDetails.account().getAccountNumber()}</title>
    </head>
    ...
    <body>
        ...
        <c:set var="endpoint" value="saving-accounts/details" scope="request"/>
        <c:set var="balanceEndpoint" value="saving-accounts/balance" scope="request"/>
